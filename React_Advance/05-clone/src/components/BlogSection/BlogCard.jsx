...
const BlogCard = ({ category, image, author, date, description, shareCount, comments, delay }) => {
    return (
        <div className="col-lg-6 col-xl-4 d-flex strech-1" data-aos="fade-in" data-aos-delay={delay}>
            <div className="blog-item d-flex flex-column position-relative bg-light rounded">
                ...
                <div className="blog-content flex-grow-1 text-center position-relative px-3" style={{ marginTop: "-25px" }}>
