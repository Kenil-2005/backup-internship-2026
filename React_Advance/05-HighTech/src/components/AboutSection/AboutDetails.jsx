                    ...
                    <div className="row g-5">
                        <div className="col-lg-5 col-md-6 col-12">
                            <div className="h-100 position-relative">
                                <img src="img/about-1.jpg" className="img-fluid w-75 rounded" data-aos="fade-down-right" data-aos-delay="200" style={{ marginBottom: "25%" }}></img>
                                <div className="position-absolute w-75" style={{ top: "25%", left: "25%" }}>
                                    <img src="img/about-2.jpg" className="img-fluid w-100 rounded" data-aos="fade-up-left" data-aos-delay="800"></img>
                                </div>
                            </div>
                        </div>
